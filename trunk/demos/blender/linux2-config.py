...
## PFC MOD: incluir aqui la libreria no es muy ortodoxo, pero no veo donde hacerlo si no
CC = 'gcc -ltpfcc'
CXX = 'g++ -ltpfcc'
##ifeq ($CPU),alpha)
...
BF_BUILDDIR = '../blendertpfc/build'
BF_INSTALLDIR='../blendertpfc'
BF_DOCDIR='../blendertpfc/doc'
